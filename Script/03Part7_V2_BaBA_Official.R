...
write.csv(encounter.df, file = ("I2_MULE_FB100_B4_P36_EncounterEvents.csv"))
...
encounter.df$Location.ID <- as.character(encounter.df$Location.ID)
...
write.csv(event.df, file = "I2_MULE_FB100_B4_P36_Step1Cls.csv")
...
event.df.1 <- event.df
write.csv(event.df.1,"I2_MULE_FB100_B4_P36_FinalCls.csv")
